...
public interface AddCommentResource {
    @Put("json")
    public ConsultationRepresentation addCommentConsultation(ConsultationRepresentation consultationRepresentation) throws NotFoundException, BadEntityException;
}
